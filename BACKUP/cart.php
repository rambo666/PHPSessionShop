...
<?php
	$connection = mysql_connect("localhost", "21110575", "21110575");
...
<?php
	...
	//if there is an product_id and that product_id doesnt exist display an error message
...
<?php
	...
	if($_SESSION['cart']) {	//if the cart isnt empty
		//show the cart
	...
	function productExists($product_id) {
			//use sprintf to make sure that $product_id is inserted into the query as a number - to prevent SQL injection
			$sql = sprintf("SELECT * FROM ShoesTable WHERE id = %d;",$product_id);
